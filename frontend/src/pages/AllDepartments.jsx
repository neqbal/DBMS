...
import { Table, TableRow, TableBody, TableCell, TableHead, TableHeadCell } from 'flowbite-react'
      ...
      <div className='min-h-screen bg-slate-50 p-6'>
        <div className="max-w-7xl mx-auto">
          <header className="mb-8">
            <h1 className="text-3xl font-bold text-gray-800 mb-2">Academic Departments</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
              ...
              >
                ...
                <p className="text-3xl font-bold text-blue-900">
                  {departments.reduce((total, dept) => total + dept.number_of_courses, 0)}
                </p>
                <p className="text-sm text-muted-foreground mt-1">Academic departments</p>
              </Card>
          </div>
                ...
                {departments.map((dep, index) => (
                  <TableRow className="bg-white" key={index}>
                    <TableCell 
                      ...
                      onClick={() => navigate(`/departments?department_id=${dep["department_id"]}`)}
                    >
                      {dep["department_id"]}
                    </TableCell>
                    ...
                    <TableCell>
                      {dep["number_of_courses"]}
                    </TableCell>
                    <TableCell>
                      {dep["number_of_students"]}
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
