    ...
    <div className="navbar">
      <Navbar fluid rounded>
        ...
        <NavbarCollapse>
          ...
          <NavbarLink href="/instructor/course" active={isActive("/instructor/course")} > Course </NavbarLink>
          <NavbarLink href="#">My modules</NavbarLink>
          <NavbarLink href="#">Pending</NavbarLink>
          <NavbarLink href="#">Quizes</NavbarLink>
          <NavbarLink href="/instructor/departments" active={isActive("/instructor/departments")}>Departments</NavbarLink>
        </NavbarCollapse>
      </Navbar>
    </div>
  );
