...
from .models import CustomUser, Departments, Instructors, Quiz, QuizSubmission, StudentCourseDetail, StudentModuleCompleted, Students, Courses, ModuleCreator, Modules, Teaches
