...
from api.views import CreateUserView, CustomeTokenObtainPairView, user_info, user_dept_courses, all_departments
...
urlpatterns = [
    ...
    path("api/user/all/departments/", all_departments, name="all_departments")
    path("api/user/")
]
